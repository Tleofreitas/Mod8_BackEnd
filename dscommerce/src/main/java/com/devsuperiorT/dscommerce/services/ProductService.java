...
public class ProductService {
    ...
    /*
    @Transactional(readOnly=true) // Lock de leitura
    // Implementar busca no banco de dados
    public ProductDTO findById(Long id) {
        // Buscar no banco de dados o Id e atribuir na variável
        Optional<Product> result = Optional.of(repository.getReferenceById(id));

        // Pegar o objeto Product dentro do Optional
        Product product = result.get();

        // Converter o Product para ProductDTO
